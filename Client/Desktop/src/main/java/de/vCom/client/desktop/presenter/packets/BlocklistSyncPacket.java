...
/**
 * Packet for transferring the list of blocked users identifiers from server to client.
 * @author Björn Lange
 */
public class BlocklistSyncPacket extends Packet {
	/**
	 * Protocol identifier for this packet.
	 */
	public static final int PROTOCOL_IDENTIFIER = 262;

	private List<UserIdentifier> blocklist;
	
	/**
	 * Gets the list of blocked users identifiers.
	 * @return Gets the list of blocked users identifiers send by the server.
	 */
	public List<UserIdentifier> getBlocklist() {
		return blocklist;
	}
	
	/**
	 * Creates a new BlocklistSyncPacket.
	 */
	public BlocklistSyncPacket() { }
	
	@Override
	public void readFrom(DataInputStream input) throws IOException {
		blocklist = readUserIdentifierList(input);
	}

	@Override
	public void writeTo(DataOutputStream output) throws IOException {
		throw new UnsupportedOperationException(
				"Client is not allowed to send a BlocklistSyncPacket!");
	}
}
